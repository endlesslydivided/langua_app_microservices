...
export class VocabularyStatsService {
  ...
  public async createOrUpdate(
    ...
    let vocabularyStats =
      await this.vocabularyStatsRepository.findOneByTodayCreatedAt(dto.userId);
  ...
  public async findMany(
    ...
    const data = await this.vocabularyStatsRepository.findManyAndCountByUserId(
      dto.userId,
      dto.pageFilters,
    );
    return {
  ...
  public async getOverallVocabularyStats(
    ...
    const overallVocabularyStats =
      await this.vocabularyStatsRepository.getOverallVocabularyStats(
        dto.userId,
      );
    return {
      status: HttpStatus.OK,
