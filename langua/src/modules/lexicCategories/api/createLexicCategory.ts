...
export const CREATE_LEXIC_CATEGORY = gql`mutation CreateLexicCategory($createLexicCategory: CreateLexicCategoryInput!) {
    createLexicCategory(createLexicCategory: $createLexicCategory)
}
`

const createLexicCategory = async ({categoryName,creatorUserId,language,nativeCategoryLanguage}:CreateLexicCategoryParams) =>
{
    try
    {
