...
export const FIND_MANY_LEXIC_CATEGORIES_BY_CREATOR_ID = gql`
    query FindManyLexicCategoriesByCreatorId(
        $limit: Int
        $page: Int
        $language: String!
...
const findManyLexicCategoriesByCreatorId = async ({
    page,
    limit,
    language,
    nativeCategoryLanguage,
    creatorId,
}: FindManyLexicCategoriesByCreatorIdParams) => {
    try {
