...
const VocabulariesListItem: FC<VocabulariesListItemProps> = ({
    index,
    value,
    array,
}) => {
    ...
    const vocabularyLanguage = countries.find(
        (i) => i.language === value.language,
    );
    const vocabularyNativeLanguage = countries.find(
        (i) => i.language === value.vocabularyNativeLanguage,
    );
    ...
    return (
        <>
            ...
            >
                ...
                <IconButton
                    onClick={() => vocabularyChooseHandler(value)}
                    color="primary"
                >
                    <BookIcon />
                </IconButton>
