...
export const CREATE_WORD_TO_VOCABULARY = gql`mutation CreateWordToVocabulary($createWordToVocabulary: CreateWordToVocabularyInput!) {
    createWordToVocabulary(createWordToVocabulary: $createWordToVocabulary)
}
`

const createWordToVocabulary = async ({vocabularyId,wordId}:CreateWordToVocabularyParams) =>
{
    try
    {
