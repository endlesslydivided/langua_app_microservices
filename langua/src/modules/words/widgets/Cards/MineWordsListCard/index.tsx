...
const MineWordsListCard:React.FC<MineWordsListCardProps> = ({lexicCategoryId}) => {
  ...
  return (
    <Box sx={{
        ...
        <FabDialog buttonIcon={<AddIcon/>} buttonTitle="Add word" dialogTitle="Create new word">
          <CreateWordForm lexicCategoryId={lexicCategoryId} creationCallback={initFetch}/>
        </FabDialog>
    </Box>
  )
}
