...
export const wordSchema = Yup.object().shape({
    ...
    transcription: Yup.string().label('Transcription').required().min(1).max(255),
...
const CreateWordForm:React.FC<CreateWordProps> = ({lexicCategoryId,creationCallback}) => {
    ...
    const wordForm = useFormik({
        initialValues:
        {
            ...
            nativeWordLanguage: auth.currentVocabulary?.vocabularyNativeLanguage || ''
        },
  ...
  return (
    <form className="flex flex-col gap-5" onSubmit={wordForm.handleSubmit}>
        ...
        <TextField 
            ...
            helperText={wordForm.errors.word && wordForm.touched.word ? wordForm.errors.word : ''}
        ...
        <TextField 
            error={!!wordForm.errors.transcription && !!wordForm.touched.transcription }
            helperText={wordForm.errors.transcription && wordForm.touched.transcription ? wordForm.errors.transcription : ''}
        ...
        <TextField 
            error={!!wordForm.errors.translation && !!wordForm.touched.translation }
            helperText={wordForm.errors.translation && wordForm.touched.translation ? wordForm.errors.translation : ''}
