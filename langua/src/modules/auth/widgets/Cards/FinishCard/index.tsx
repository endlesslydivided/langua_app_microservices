...
const FinishCard = () => {
    ...
    const onVocabularySubmit = async (values: VocabularyForm) => {
        try {
            ...
            toast(MessageType.SUCCESSFULL_VOCABULARY, {
                autoClose: 10000,
                type: 'success',
            });
        } catch (error) {
    ...
    return (
        ...
        >
            <CardHeader
                title={`Finish registration. Step ${activeStep + 1} of 3`}
            />
            <CardContent>
                <Stack spacing={2}>
                    <FinishStepper
                                ...
                                0: (
                                    <Stack spacing={2}>
                                        ...
                                        <LanguageSelect
                                            exclude={['Other']}
                                            label="Base language"
                                            fieldProps={vocabularyForm.getFieldProps(
                                                'vocabularyNativeLanguage',
                                            )}
                                        />
                                        <Typography sx={{ color: 'gray' }}>
                                            The language you know and want your
                                            lexical materials to be translated
                                            to.
                                        </Typography>
                                    </Stack>
                                ),
                                1: (
                                    <Stack spacing={2}>
                                        ...
                                        <Typography sx={{ color: 'gray' }}>
                                            ...
                                            lexical materials would be presented
                                            to you on.
                                        </Typography>
                                    </Stack>
                                ),
                                2: (
                                    <Stack spacing={2}>
                                        ...
                                        <Stack spacing={1}>
                                            <TextField
                                                error={
                                                    !!finishRegisterForm.errors
                                                        .phoneNumber &&
                                                    !!finishRegisterForm.touched
                                                        .phoneNumber
                                                }
                                                helperText={
                                                    finishRegisterForm.errors
                                                ...
                                                {...finishRegisterForm.getFieldProps(
                                                    'phoneNumber',
                                                )}
                                                type="tel"
                                                name="phoneNumber"
                                            ...
                                            <LanguageSelect
                                                ...
                                                fieldProps={finishRegisterForm.getFieldProps(
                                                    'nativeLanguage',
                                                )}
                                            />
                                        </Stack>
