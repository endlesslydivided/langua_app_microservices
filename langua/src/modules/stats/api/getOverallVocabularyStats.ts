...
export const GET_OVERALL_VOCABULARY_STATS = gql`query GetOverallVocabularyStats($userId: String!) {
...
const getOverallVocabularyStats = async ({userId}:GetOverallVocabularyStatsParams) =>
{
    try
    {
