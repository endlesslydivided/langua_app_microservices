...
query FindManyWordsByVocabularyId($vocabularyId: String!, $limit: Int, $page: Int) {
...
export default async function VocabularyPage(props:VocabularyPageProps) {
  ...
  const {data} = await getClient().query({query:FIND_MANY_WORDS_BY_VOCABULARY_ID,variables:
  {
